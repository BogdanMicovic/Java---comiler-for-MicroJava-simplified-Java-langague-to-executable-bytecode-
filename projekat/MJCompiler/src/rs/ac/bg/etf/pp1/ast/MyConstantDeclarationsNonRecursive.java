...
public class MyConstantDeclarationsNonRecursive extends ConstantDeclarations {

    private ConstantDeclaration ConstantDeclaration;

    public MyConstantDeclarationsNonRecursive (ConstantDeclaration ConstantDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MyConstantDeclarationsNonRecursive(\n");
